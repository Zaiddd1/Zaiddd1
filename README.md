...
- 🎓 **Systems Engineering** student — Universidad Católica de Santa María (Arequipa, Perú)
- 🧩 Focused on **programming fundamentals**: data structures, algorithms and **Object-Oriented Programming**
- 🔁 Moving between **Java**, **C++** and **Python**, comparing how each one solves the same problem
- 🌱 Currently learning: clean OOP design, Git/GitHub workflows and problem solving
- ⚡ I keep a public log of my coursework and exercises so I can look back and see the progress
...
<!--
  Contact section left out for now — when you want it, drop badges like these into a
  "## 📫 Contact" heading:
